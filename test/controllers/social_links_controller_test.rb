...
class SocialLinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_link" do
    assert_difference("SocialLink.count") do
      post social_links_url, params: { social_link: { icon: @social_link.icon, platform: @social_link.platform, url: @social_link.url } }, as: :json
    end
  ...
  test "should update social_link" do
    patch social_link_url(@social_link), params: { social_link: { icon: @social_link.icon, platform: @social_link.platform, url: @social_link.url } }, as: :json
    assert_response :success
  end
